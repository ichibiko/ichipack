...
cat <<\EOF_15da8006a8a6a7a3022639c048e1d1742f2b3f9c > $WORKING_DIR/etc/exists-lf.txt
exists new line
at end of file
EOF_15da8006a8a6a7a3022639c048e1d1742f2b3f9c

base64 -d <<\EOF_d4e1aebe6d7e4db0fc3c176f947a51b5e28a89ca > $WORKING_DIR/etc/no-lf.txt
bm8gbmV3IGxpbmUKYXQgZW5kIG9mIGZpbGU=
EOF_d4e1aebe6d7e4db0fc3c176f947a51b5e28a89ca

cat <<\EOF_3f14f062ed11d6580e72ef115e37288159a560f4 > $WORKING_DIR/main.sh
